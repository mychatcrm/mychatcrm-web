-- Acrescenta os campos novos de sincronização/OAuth do conector no snapshot
-- de dashboard/integracoes (auth_config só carrega tokenUrl/clientId, nunca
-- segredo — client_secret continua só em credential_ciphertext).
    ...
    'external_apis', jsonb_build_object(
      ...
      'connectors', coalesce((
        select jsonb_agg(jsonb_build_object(
          ...
          'oauth_token_url', connector.auth_config->>'tokenUrl',
          'oauth_client_id', connector.auth_config->>'clientId',
          ...
          'sync_operation_key', connector.sync_operation_key,
          ...
          'last_sync_item_count', connector.last_sync_item_count,
