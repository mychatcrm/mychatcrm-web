...
export const metadata: Metadata = {
  title: "Blog MyChatCRM | Chatbot, CRM, automação e conversão por nicho",
  description:
    "Guias completos para aplicar chatbot, CRM, automação, atendimento e conversão em 30 nichos de mercado com foco em SEO, IA e vendas.",
  alternates: { canonical: "/blog" },
  openGraph: {
    title: "Blog MyChatCRM | Guias de chatbot e CRM por nicho",
    description:
      "Conteúdo profissional para automatizar atendimento, organizar CRM e aumentar conversão no WhatsApp.",
    url: `${SITE_URL}/blog`,
    images: ["/og-image.png"],
  },
};
...
export default function BlogPage({
  ...
  searchParams?: { q?: string | string[]; niche?: string | string[] };
}) {
