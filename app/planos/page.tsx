...
export const metadata: Metadata = {
  title: "Planos e assinaturas | MyChatCRM",
  description:
    "Compare os planos MyChatCRM: IA no WhatsApp, CRM Kanban, agenda e integrações. Escolha o plano e finalize a assinatura com segurança.",
  alternates: { canonical: "/planos" },
  openGraph: {
    title: "Planos MyChatCRM — IA no WhatsApp + CRM Kanban",
    description:
      "Planos Solo, Equipa, Escala e opção Enterprise (sob consulta). Preços e checkout para os três primeiros; comparativo detalhado sem Enterprise.",
    url: `${SITE_URL}/planos`,
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "MyChatCRM — Planos e preços" }],
  },
};
