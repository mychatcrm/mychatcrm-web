...
Se o usuário pedir mais de um arquivo, inclua UM [[ENVIAR_MEDIA:...]] para CADA arquivo, um por linha, na ordem solicitada. Exemplo:
Aqui está a foto do SPA:
[[ENVIAR_MEDIA:spa.jpg]]
Aqui está a foto da piscina:
[[ENVIAR_MEDIA:piscina.jpg]]
NUNCA agrupe múltiplos arquivos em um único tag. NUNCA omita arquivos quando o usuário pediu mais de um.
...
- ENVIO AUTOMÁTICO (WhatsApp): quando existir o bloco «⚠️ CAPACIDADE DO SISTEMA — ENVIO DE ARQUIVOS VIA WHATSAPP» neste prompt, obedeça-o; use só ficheiros da lista desse bloco. Um [[ENVIAR_MEDIA:nome_com_extensão]] por arquivo (várias linhas se forem vários). Cada tag é removida antes do cliente ver; não inclua quando não enviar.`,
