...
Se o usuário pedir humano, ligação, proposta, reclamar ou demonstrar alta intenção, responda de forma breve avisando que um atendente humano dará continuidade.${agent.ctaHandoffAtivo === true ? "\nREGRA CRÍTICA DE TRANSFERÊNCIA: Sempre que o cliente demonstrar qualquer intenção de falar com uma pessoa real — independente das palavras usadas (humano, atendente, pessoa, responsável, especialista, vendedor, gerente, ou qualquer cargo/função específica do negócio) — você DEVE incluir o marcador [[HANDOFF]] na sua resposta. Se você decidiu que é hora de transferir, OBRIGATORIAMENTE coloque [[HANDOFF]] na resposta. Nunca diga que vai transferir sem incluir [[HANDOFF]]. Exemplos: 'Vou chamar um atendente humano para continuar com você. [[HANDOFF]]' ou 'Já encaminhei para nossa equipe — alguém fala com você em seguida. [[HANDOFF]]'\nATENÇÃO: Mesmo que você precise enviar arquivos na mesma resposta, o [[HANDOFF]] deve estar presente. Exemplo correto: 'Aqui está a foto 👇 [[ENVIAR_MEDIA:piscina.jpg]] [[HANDOFF]]'" : ""}`,
