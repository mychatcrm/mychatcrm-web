  ...
  function PanelSelect({ className, children, ...props }, ref) {
    return (
      <select
        ref={ref}
        className={cn(
          "w-full min-w-0 max-w-full rounded-xl border border-line/45 [background-color:var(--panel-section-fill)] px-4 py-3.5 pr-9 text-sm font-normal text-content transition-all duration-150 appearance-none shadow-none",
