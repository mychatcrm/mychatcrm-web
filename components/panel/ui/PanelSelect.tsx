  ...
  function PanelSelect({ className, children, ...props }, ref) {
    return (
      <select
        ref={ref}
        className={cn(
          "w-full rounded-xl border border-line/80 bg-surface-base px-4 py-3.5 pr-9 text-sm font-normal text-content transition-all duration-150 appearance-none shadow-none",
          ...
          "hover:border-line",
          "focus:border-primary/70 focus:bg-surface-deep focus:outline-none",
