  ...
  function PanelSelect({ className, children, ...props }, ref) {
    return (
      <select
        ref={ref}
        className={cn(
          "w-full rounded-panel-xl border border-line/80 bg-surface-base px-4 py-3.5 pr-9 text-sm font-normal text-content transition-all duration-150 appearance-none",
