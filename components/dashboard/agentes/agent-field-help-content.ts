...
export const AGENT_FIELD_HELP = {
  ...
  followUpCooldown: 'Intervalo mínimo entre dois follow-ups consecutivos para o mesmo lead (anti-spam). Mínimo recomendado: 30 min.',
  followUpSla: 'Quantas horas sem resposta configuram violação de SLA. Quando violado, o agente prioriza este lead. Deixe vazio para desativar.',
  followUpHorario: 'Janela de horário (em UTC) em que o envio é permitido. Fora dela o follow-up é reagendado automaticamente.',
  followUpDias: 'Dias da semana em que o follow-up pode ser enviado. Deixe todos desmarcados para permitir qualquer dia.',
  followUpSoHumano: 'Quando ativado, o agente só faz follow-up se um humano estava atendendo e parou de responder — evita interferir em leads que o agente já atendeu sozinho.',
